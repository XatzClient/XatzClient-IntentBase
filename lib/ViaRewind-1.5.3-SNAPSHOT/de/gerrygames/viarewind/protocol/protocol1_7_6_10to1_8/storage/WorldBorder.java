...
public class WorldBorder extends StoredObject implements Tickable
{
    ...
    private void sendPackets() {
        final PlayerPosition position = (PlayerPosition)this.getUser().get((Class)PlayerPosition.class);
        ...
        for (final Side side : Side.values()) {
            ...
            if (d < 16.0) {
                ...
                final double b = 2.5;
                final PacketWrapper particles = new PacketWrapper(42, (ByteBuf)null, this.getUser());
                particles.write(Type.STRING, (Object)"fireworksSpark");
                particles.write((Type)Type.FLOAT, (Object)(float)((side.modX != 0) ? (this.x + radius * side.modX) : centerH));
                particles.write((Type)Type.FLOAT, (Object)(float)centerV);
                particles.write((Type)Type.FLOAT, (Object)(float)((side.modX == 0) ? (this.z + radius * side.modZ) : centerH));
                particles.write((Type)Type.FLOAT, (Object)(float)((side.modX != 0) ? 0.0 : ((maxH - minH) / b)));
                particles.write((Type)Type.FLOAT, (Object)(float)((maxV - minV) / b));
                particles.write((Type)Type.FLOAT, (Object)(float)((side.modX == 0) ? 0.0 : ((maxH - minH) / b)));
                particles.write((Type)Type.FLOAT, (Object)0.0f);
                particles.write(Type.INT, (Object)a);

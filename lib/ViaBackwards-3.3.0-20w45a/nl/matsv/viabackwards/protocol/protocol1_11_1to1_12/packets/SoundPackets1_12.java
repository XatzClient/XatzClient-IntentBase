...
public class SoundPackets1_12 extends LegacySoundRewriter<Protocol1_11_1To1_12>
{
    ...
    protected void registerPackets() {
        ((Protocol1_11_1To1_12)this.protocol).registerOutgoing((ClientboundPacketType)ClientboundPackets1_12.NAMED_SOUND, (PacketRemapper)new PacketRemapper() {
        ...
        ((Protocol1_11_1To1_12)this.protocol).registerOutgoing((ClientboundPacketType)ClientboundPackets1_12.SOUND, (PacketRemapper)new PacketRemapper() {
            public void registerMap() {
                this.map((Type)Type.VAR_INT);
                this.map((Type)Type.VAR_INT);
                this.map(Type.INT);
                ...
                this.handler((PacketHandler)new PacketHandler() {
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        if (SoundPackets1_12.this.hasPitch(oldId)) {
                            wrapper.set((Type)Type.FLOAT, 1, (Object)SoundPackets1_12.this.handlePitch(oldId));
                        }

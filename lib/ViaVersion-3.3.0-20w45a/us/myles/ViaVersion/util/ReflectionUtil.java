...
public class ReflectionUtil
{
    ...
    public static <T> T getStatic(final Class<?> clazz, final String f, final Class<T> t) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static <T> T getSuper(final Object o, final String f, final Class<T> t) throws NoSuchFieldException, IllegalAccessException {
        final Field field = o.getClass().getSuperclass().getDeclaredField(f);
        field.setAccessible(true);
        return (T)field.get(o);
    }
    
    public static <T> T get(final Object instance, final Class<?> clazz, final String f, final Class<T> t) throws NoSuchFieldException, IllegalAccessException {
        final Field field = clazz.getDeclaredField(f);
        field.setAccessible(true);
        return (T)field.get(instance);
    }
    
    public static <T> T get(final Object o, final String f, final Class<T> t) throws NoSuchFieldException, IllegalAccessException {
        final Field field = o.getClass().getDeclaredField(f);
        field.setAccessible(true);
        return (T)field.get(o);
    }
    
    public static <T> T getPublic(final Object o, final String f, final Class<T> t) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static final class ClassReflection
    {
        ...
        public ClassReflection(final Class<?> handle, final boolean recursive) {
            this.fields = (Map<String, Field>)Maps.newConcurrentMap();
            this.methods = (Map<String, Method>)Maps.newConcurrentMap();

            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        final short action = wrapper.get(Type.UNSIGNED_BYTE, 0);
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        final short action = wrapper.get(Type.UNSIGNED_BYTE, 0);
                        final short param = wrapper.get(Type.UNSIGNED_BYTE, 1);
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        for (int i = 0; i < recordCount; ++i) {
                            final Position position = new Position(x + wrapper.passthrough(Type.BYTE), (short)(y + wrapper.passthrough(Type.BYTE)), z + wrapper.passthrough(Type.BYTE));
                            records[i] = position;
        ...
        protocol.registerOutgoing(ClientboundPackets1_12_1.NAMED_SOUND, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    @Override
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        final String newSoundId = NamedSoundRewriter.getNewId(wrapper.get(Type.STRING, 0));
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        for (final CompoundTag tag : chunk.getBlockEntities()) {
                            ...
                            if (newId3 != -1) {
                                final int x2 = (int)tag.get("x").getValue();
                                final int y2 = (int)tag.get("y").getValue();
                                final int z2 = (int)tag.get("z").getValue();
        ...
        protocol.registerOutgoing(ClientboundPackets1_12_1.SPAWN_PARTICLE, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    @Override
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        final int particleId = wrapper.get(Type.INT, 0);
                        int dataCount = 0;
                        ...
                        if (particle.getId() == 11) {
                            final int count = wrapper.get(Type.INT, 1);

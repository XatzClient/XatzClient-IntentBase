...
public class BlockConnectionStorage extends StoredObject
{
    ...
    public BlockConnectionStorage(final UserConnection user) {
        super(user);
    ...
    static {
        ...
        try {
            BlockConnectionStorage.fastUtilLongObjectHashMap = Class.forName("us.myles.viaversion.libs.fastutil.longs.Long2ObjectOpenHashMap").getConstructor((Class<?>[])new Class[0]);

...
public class ProtocolVersion
{
    ...
    public static ProtocolVersion register(final int version, final String name, @Nullable final VersionRange versionRange) {
        return register(version, -1, name, versionRange);
    }
    
    public static ProtocolVersion register(final int version, final int snapshotVersion, final String name, @Nullable final VersionRange versionRange) {
    ...
    public ProtocolVersion(final int version, final int snapshotVersion, final String name, @Nullable final VersionRange versionRange) {
    ...
    static {
        ...
        v1_16_4 = register(754, "1.16.4");
        v1_17 = register(755, 5, "1.17");

...
public class NBTIO
{
    ...
    public static Tag readTag(final InputStream in) throws IOException {
        return readTag(in, false);
    }
    
    public static Tag readTag(final InputStream in, final boolean littleEndian) throws IOException {
        return readTag(littleEndian ? new LittleEndianDataInputStream(in) : new DataInputStream(in));
    }
    
    public static Tag readTag(final DataInput in) throws IOException {
    ...
    public static void writeTag(final OutputStream out, final Tag tag) throws IOException {
        writeTag(out, tag, false);
    }
    
    public static void writeTag(final OutputStream out, final Tag tag, final boolean littleEndian) throws IOException {
        writeTag(littleEndian ? new LittleEndianDataOutputStream(out) : new DataOutputStream(out), tag);
    }
    
    public static void writeTag(final DataOutput out, final Tag tag) throws IOException {
